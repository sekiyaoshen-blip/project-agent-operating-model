...
- Relevant files / docs:
  ...
  - `docs/modules/example-module/status.md`
  - `docs/modules/example-module/handoff.md`
- Dependencies:
- Constraints:
...
You are resuming `TASK-0001`.

Read first:

- `docs/thread-registry.md`
- `docs/thread-runs/TASK-0001.md`
- `docs/modules/example-module/status.md`
- `docs/modules/example-module/handoff.md`
- `docs/modules/example-module/runbook.md`
...
- `docs/thread-runs/inbox/main/RET-TASK-0001-example-module-YYYYMMDD-HHMM.md`
